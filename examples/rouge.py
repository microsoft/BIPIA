...
_DESCRIPTION = """\
The recall version of ROUGE, replaces the F1 score with recall.
"""
...
Returns:
    rouge1: rouge_1 (recall),
    rouge2: rouge_2 (recall),
    rougeL: rouge_l (recall),
    rougeLsum: rouge_lsum (recall)
"""
